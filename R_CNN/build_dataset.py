from pyimagesearch_RCNN.iou import compute_iou
from pyimagesearch_RCNN import config
...
for (i, imagePath) in enumerate(imagePaths):
    ...
    #extract the filename from the file path and use it to derive the path to the XML annotaion file
    ...
    #initialize counters used to count the number of positive and negative ROIs save thus far
    positiveROIs = 0
    negativeROIs = 0
